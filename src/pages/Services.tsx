  ...
  return (
    <section>
        ...
        <h2 className='text-redText font-bold text-center text-5xl p-20'>
            ...
            <div className='flex flex-col-reverse items-center md:flex-row h-[500px]'>
            ...
            <div className='flex flex-col md:flex-row items-center w-full h-[500px]'>
            ...
            <div className='flex flex-col-reverse md:flex-row w-full justify-center h-[500px]'>
